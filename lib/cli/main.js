...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make bitcore-node-pivx a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-pivx create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-pivx add wallet-service');
      console.log('    $ bitcore-node-pivx add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-pivx remove wallet-service');
      console.log('    $ bitcore-node-pivx remove insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(method, paramsArg) {
      ...
      console.log('Node port: '+options.port);
