...
describe('Bitcoin Cluster', function() {
  var node;
  var daemons = [];
  var execPath = path.resolve(__dirname, process.env.HOME, './.bitcore/data/pivxd')
  var nodesConf = [
    {
      datadir: path.resolve(__dirname, './data/node1'),
      conf: path.resolve(__dirname, './data/node1/pivx.conf'),
      rpcuser: 'bitcoin',
    ...
    },
    {
      ...
      conf: path.resolve(__dirname, './data/node2/pivx.conf'),
      rpcuser: 'bitcoin',
      rpcpassword: 'local321',
      rpcport: 30522,
    ...
    },
    {
      ...
      conf: path.resolve(__dirname, './data/node3/pivx.conf'),
      rpcuser: 'bitcoin',
      rpcpassword: 'local321',
      rpcport: 30523,
  ...
  before(function(done) {
    log.info('Starting 3 pivxd daemons');
    this.timeout(200000);
